...
#ifndef TC_NETWORKBUFFER_H
#define TC_NETWORKBUFFER_H
...
public:
    ...
    * @return PACKET_TYPE
    ...
    static PACKET_TYPE parseBinary1(TC_NetWorkBuffer&in, vector<char> &out)
    {
    ...
    static PACKET_TYPE parseBinary2(TC_NetWorkBuffer&in, vector<char> &out)
    {
    ...
    static PACKET_TYPE parseBinary4(TC_NetWorkBuffer&in, vector<char> &out)
    {
