...
#include <stdexcept>
#include <string.h>
#include "client/protocol/TarsType.h"
#include "client/util/tc_json.h"
...
{
public:
    static void readJson(horsedb::Bool& b, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeBoolean)
        {
            b = dynamic_cast<JsonValueBoolean*>(p.get())->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Char& c, const JsonValuePtr & p, bool isRequire = true)
    {
        ...
        {
            c = (char)dynamic_cast<JsonValueNum*>(p.get())->value;//(char)JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(UInt8& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeNum)
        {
            n = (UInt8)dynamic_cast<JsonValueNum*>(p.get())->value;//(UInt8)JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Short& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeNum)
        {
            n = (Short)dynamic_cast<JsonValueNum*>(p.get())->value;//(Short)JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(UInt16& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeNum)
        {
            n = (UInt16)dynamic_cast<JsonValueNum*>(p.get())->value;//(UInt16)JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Int32& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeNum)
        {
            n = (Int32)dynamic_cast<JsonValueNum*>(p.get())->value;//(Int32)JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(UInt32& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeNum)
        {
            n = (UInt32)dynamic_cast<JsonValueNum*>(p.get())->value;//(UInt32)JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Int64& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeNum)
        {
            n = (Int64)dynamic_cast<JsonValueNum*>(p.get())->value;//(Int64)JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Float& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeNum)
        {
            n = (Float)dynamic_cast<JsonValueNum*>(p.get())->value;//(Float)JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Double& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeNum)
        {
            n = dynamic_cast<JsonValueNum*>(p.get())->value;//JsonValueNumPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(std::string& s, const JsonValuePtr & p, bool isRequire = true)
    {
        ...
        {
            s = dynamic_cast<JsonValueString*>(p.get())->value;//JsonValueStringPtr::dynamicCast(p)->value;
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(char *buf, const UInt32 bufLen, UInt32 & readLen, const JsonValuePtr & p, bool isRequire = true)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeString)
        {
            JsonValueStringPtr pString(dynamic_cast<JsonValueString*>(p.get()));//JsonValueStringPtr::dynamicCast(p);
    ...
    static void readJson(std::map<string, V, Cmp, Alloc>& m, const JsonValuePtr & p, bool isRequire = true)
    {
        ...
        {
            JsonValueObjPtr pObj(dynamic_cast<JsonValueObj*>(p.get()));//=JsonValueObjPtr::dynamicCast(p);
    ...
    static void readJson(std::vector<T, Alloc>& v, const JsonValuePtr & p, bool isRequire = true)
    {
        ...
        {
            JsonValueArrayPtr pArray(dynamic_cast<JsonValueArray*>(p.get()));//=JsonValueArrayPtr::dynamicCast(p);
...
public:
    ...
    {
        return make_shared<JsonValueNum> (n,true);
    }
    ...
    {
        return make_shared<JsonValueNum> ((double)n,true);//(new JsonValueNum((double)n,true));
    }

    static JsonValueNumPtr writeJson(Float n)
    {
        return make_shared<JsonValueNum> (n);//(new JsonValueNum(n));
    }

    static JsonValueNumPtr writeJson(Double n)
    {
        return make_shared<JsonValueNum> (n);;
    }

    static JsonValueStringPtr writeJson(const std::string& s)
    {
        return make_shared<JsonValueString> (s);//(new JsonValueString(s));
    }

    static JsonValueStringPtr writeJson(const char *buf, const UInt32 len)
    {
        return make_shared<JsonValueString> (string(buf,len));//(new JsonValueString(string(buf,len)));
    }
    ...
    {
        JsonValueArrayPtr pArray(new JsonValueArray());//=new JsonValueArray();
